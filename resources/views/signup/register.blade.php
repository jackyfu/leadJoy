...
<div>
    ...
    <div>
        <div class="input">
            ...
            <input type="password" placeholder="请再次输入密码" id="repassword" name="repassword" class="input-txt" onfocus="getFocus(this);" onblur"loseFocus(this);">
            <input type="submit" style="color:#ffffff; height:30px; width:75%; background: #14aebd;" value="注册" class="submit-btn" />
...
<script type="text/javascript">
    $(".submit-btn").click(function(){
        $.ajax({
            type: "POST",
            url: "/signup",
            data: {_token: "{{csrf_token()}}", 'username': $('#username').val(), 'password': $('#password').val(),'repassword': $('#repassword').val()},
